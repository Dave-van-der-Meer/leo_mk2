...
#include "docker_messages/msg/detail/docker_statistics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = docker_messages::msg::DockerStatistics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const docker_messages::msg::DockerStatistics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<docker_messages::msg::DockerStatistics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DockerStatistics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const docker_messages::msg::DockerStatistics *>(
...
static size_t _DockerStatistics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DockerStatistics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DockerStatistics__callbacks = {
  "docker_messages::msg",
  "DockerStatistics",
...
static rosidl_message_type_support_t _DockerStatistics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DockerStatistics__callbacks,
...
get_message_type_support_handle<docker_messages::msg::DockerStatistics>()
{
  return &docker_messages::msg::typesupport_fastrtps_cpp::_DockerStatistics__handle;
}
