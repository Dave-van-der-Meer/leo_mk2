...
static const _DockerStatistics_type_support_symbol_names_t _DockerStatistics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, docker_messages, msg, DockerStatistics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, docker_messages, msg, DockerStatistics)),
  }
};
...
{
  return &::docker_messages::msg::rosidl_typesupport_cpp::DockerStatistics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, docker_messages, msg, DockerStatistics)() {
  return get_message_type_support_handle<docker_messages::msg::DockerStatistics>();
}
