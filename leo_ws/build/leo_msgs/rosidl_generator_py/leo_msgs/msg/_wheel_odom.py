...
class Metaclass_WheelOdom(type):
    """Metaclass of message 'WheelOdom'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'leo_msgs.msg.WheelOdom')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__wheel_odom
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__wheel_odom
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__wheel_odom
            cls._TYPE_SUPPORT = module.type_support_msg__msg__wheel_odom
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__wheel_odom
...
class WheelOdom(metaclass=Metaclass_WheelOdom):
    """Message class 'WheelOdom'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.velocity_lin = kwargs.get('velocity_lin', float())
    ...
    def __eq__(self, other):
        ...
        if self.stamp != other.stamp:
            return False
        if self.velocity_lin != other.velocity_lin:
            return False
    ...
    def velocity_lin(self):
        """Message field 'velocity_lin'."""
        return self._velocity_lin

    @velocity_lin.setter
    def velocity_lin(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'velocity_lin' field must be of type 'float'"
        self._velocity_lin = value
